...
(function(){
  ...
  async function upload(file,meta){
    ...
    var row=await window.ADCloudCRUD.insert('documents',{case_id:meta&&meta.caseId||null,client_id:meta&&meta.clientId||null,file_name:file.name,storage_path:path,mime_type:file.type||null,file_size:file.size});
    return row;
  }
