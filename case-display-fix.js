...
(function(){
  ...
  function patchVisibleCases(){
    ...
    rows.forEach((row,index)=>{
      ...
      caseCell.innerHTML=`<span class="case-link">${escapeHtml(number)}</span><br><span class="muted">${escapeHtml(title)}</span>`;
  ...
  const observer=new MutationObserver(()=>{if(document.getElementById('caseTable'))patchVisibleCases();});
