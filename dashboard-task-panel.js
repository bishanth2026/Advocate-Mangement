(function(){
  ...
  function render(){
    ...
    panel.querySelector('[data-dashboard-view-tasks]').addEventListener('click',function(){if(typeof window.navigate==='function')window.navigate('tasks');else{var b=document.querySelector('.nav-item[data-page="tasks"]');if(b)b.click()}});
  }
  function start(){
    var c=document.getElementById('content');if(!c)return;
    new MutationObserver(function(){render()}).observe(c,{childList:true,subtree:true});
    render();
  }
